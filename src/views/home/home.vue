<template>
   ...
   <!-- FEATURED PRODUCTS -->
   <section
      class="featured-products py-[60px] md:py-[43px] lg:pt-[84px] lg:pb-[100px]"
   >
      <!-- MARGIN -->
         ...
         >
            ...
            <div class="relative bottom-0 overflow-visible flex items-center justify-center lg:w-full lg:justify-end lg:mt-[100px] pxl:mt-[128px]">
               ...
               <picture class="relative z-2">
                  ...
                  <img src="@/assets/imgs/home/mobile/image-speaker-zx9.png" alt="zx9_speaker" class="w-[172.25px] lg:w-[350px] pxl:w-[375px]">
               </picture>
            </div>
